                ...
                <div className="absolute inset-0 bg-gradient-to-r from-[#132018]/85 via-[#2f3b25]/55 to-[#132018]/10 flex items-center">
                    <div className="container mx-auto px-4 sm:px-6">
                        <motion.div
                            ...
                            className="max-w-5xl text-[#fff8ea]"
                        >
                            <motion.div
                            ...
                            <h1 className="max-w-3xl text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-6 leading-tight drop-shadow-2xl text-[#f7f1df]">
