            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        <Link to="/farms" className="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition">Explore Farms</Link>
                        ...
                        {user ? (
                            <>
                                {user.role === 'admin' && (
                                    <>
                                        <Link to="/admin" className="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition">Admin</Link>
                                        <Link to="/database" className="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition">Database</Link>
                                    </>
                                )}
                                <Link to="/profile" className="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition">Profile</Link>
                                <Link to="/bookings" className="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition">My Bookings</Link>
                                <Link to="/favorites" className="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition">Favorites</Link>
                                <span className="text-gray-800 dark:text-gray-200 font-medium">Hi, {user.name}</span>
                                <button onClick={logout} className="text-red-500 hover:text-red-600 dark:text-red-400 dark:hover:text-red-500 transition">Logout</button>
                            </>
                        ) : (
                            <>
                                <Link to="/login" className="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition">Login</Link>
